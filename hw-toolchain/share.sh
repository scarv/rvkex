...
export ROCKET_GNU_REPO="${REPO_HOME}/work/hw-toolchain/riscv-gnu-toolchain"
export ROCKET_GNU_COMMIT="b468107e701433e1caca3dbc8aef8d40e0c967ed"
export ROCKET_GNU_PATCH="${REPO_HOME}/hw-toolchain/riscv-gnu.patch"
...
export ROCKET_FESVR_PATCH="${REPO_HOME}/hw-toolchain/riscv-fesvr.patch"
