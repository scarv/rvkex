...
void mpi56_carry_prop(uint64_t *a)
{
  ...
  a[11]+= a[10]>> 56; a[10]&= MASK56;
  a[12]+= a[11]>> 56; a[11]&= MASK56;
  a[13]+= a[12]>> 56; a[12]&= MASK56;
} 
...
void mpi_conv_64to56(uint64_t *r, const uint64_t *a)
{
  ...
  r[11]= ((a[9] >> 40) | (a[10]<< 24)) & MASK56;
  r[12]= ((a[10]>> 32) | (a[11]<< 32)) & MASK56;
  r[13]= ( a[11]>> 24                ) & MASK56;
}
...
void mpi_conv_56to64(uint64_t *r, const uint64_t *a)
{
  ...
  r[8] = (a[9] >>  8) | (a[10]<< 48);
  r[9] = (a[10]>> 16) | (a[11]<< 40);
  r[10]= (a[11]>> 24) | (a[12]<< 32);
  r[11]= (a[12]>> 32) | (a[13]<< 24);
  r[12]= (a[13]>> 40)               ;
}
