...
{  
  ...
  puts("\n**************************************************************************");
  puts("SCALAR GFP ARITH 1w:\n");

  printf("- gfp mul 1w v0:");

  LOAD_CACHE(gfp_mul_1w_v0(r51, a51, b51), 100);
  MEASURE_CYCLES(gfp_mul_1w_v0(r51, a51, b51), 1000);
  printf("      #inst = %lld\n", diff_cycles);
  ...
  LOAD_CACHE(gfp_mul_1w_v0_ise(r51, a51, b51), 100);
  MEASURE_CYCLES(gfp_mul_1w_v0_ise(r51, a51, b51), 1000);
  printf("  #inst = %lld\n", diff_cycles);
  ...
  printf("- gfp sqr 1w v0:");

  LOAD_CACHE(gfp_sqr_1w_v0(r51, a51), 100);
  MEASURE_CYCLES(gfp_sqr_1w_v0(r51, a51), 1000);
  printf("      #inst = %lld\n", diff_cycles);
  ...
  printf("- gfp sqr 1w v0 ise:");

  LOAD_CACHE(gfp_sqr_1w_v0_ise(r51, a51), 100);
  MEASURE_CYCLES(gfp_sqr_1w_v0_ise(r51, a51), 1000);
  printf("  #inst = %lld\n", diff_cycles);
  ...
  printf("- gfp add 1w v0:");

  LOAD_CACHE(gfp_add_1w_v0(r51, a51, b51), 100);
  MEASURE_CYCLES(gfp_add_1w_v0(r51, a51, b51), 1000);
  printf("      #inst = %lld\n", diff_cycles);
  ...
  printf("- gfp sub 1w v0:");

  LOAD_CACHE(gfp_sub_1w_v0(r51, a51, b51), 100);
  MEASURE_CYCLES(gfp_sub_1w_v0(r51, a51, b51), 1000);
  printf("      #inst = %lld\n", diff_cycles);
  ...
  printf("- gfp mul51 1w v0:");

  LOAD_CACHE(gfp_mul51_1w_v0(r51, a51, (CONSTA+2)/4), 100);
  MEASURE_CYCLES(gfp_mul51_1w_v0(r51, a51, (CONSTA+2)/4), 1000);
  printf("    #inst = %lld\n", diff_cycles);
  ...
  printf("- gfp mul51 1w v0 ise:");

  LOAD_CACHE(gfp_mul51_1w_v0_ise(r51, a51, (CONSTA+2)/4), 100);
  MEASURE_CYCLES(gfp_mul51_1w_v0_ise(r51, a51, (CONSTA+2)/4), 1000);
  printf("#inst = %lld\n", diff_cycles);
...
void test_curve_arith()
{
  ...
  printf("- mon ladder step 1w:");

  LOAD_CACHE(mon_ladder_step_1w(&p, &q, xd51), 10);
  MEASURE_CYCLES(mon_ladder_step_1w(&p, &q, xd51), 100);
  printf(" #inst = %lld\n", diff_cycles);
  ...
  LOAD_CACHE(mon_mul_varbase_1w(r64, k64, x64), 10);
  MEASURE_CYCLES(mon_mul_varbase_1w(r64, k64, x64), 50);
  printf(" #inst = %lld\n", diff_cycles);
...
void test_ecdh()
{
  ...
  puts("--------------------------------------------------------------------------");
  puts("X25519 1w: (Alice <---> Bob, RFC7748 test vectors)");
  ...
  mon_mul_varbase_1w(pk_a.t64, sk_a.t64, base_pt.t64);
  mon_mul_varbase_1w(pk_b.t64, sk_b.t64, base_pt.t64);

  puts("\n- Public key:");
  mpi64_print("  Alice: ", pk_a.t64, 4);
  mpi64_print("  Bob  : ", pk_b.t64, 4);

  mon_mul_varbase_1w(ss_a.t64, sk_a.t64, pk_b.t64);
  mon_mul_varbase_1w(ss_b.t64, sk_b.t64, pk_a.t64);
  ...
  // ---------------------------------------------------------------------------
  puts("X25519 1w: (Carol <---> Dave, random test vectors)");
